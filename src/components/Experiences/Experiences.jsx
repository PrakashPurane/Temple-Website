          ...
          <ul ref={slider}>
            <li>
              <div className="slide">
                ...
                <p>
                  Visiting all these temples make my heart so pure. I suggest
                  everyone to visit temples and purify all their bad souls. It
                  helps to make you peace ,calm and keep you fit and healthy
                </p>
              </div>
            </li>
            <li>
